...
# 데이터 불러오기
movies = pd.read_csv('csv\\tmdb_5000_movies.csv')
credits = pd.read_csv('csv\\tmdb_5000_credits.csv')
...
# 모델 학습
histoty = model.fit([train['userId'], train['id']], train['rating'],
                    batch_size=64,
                    epochs=10,
                    verbose=1,
...
ax2.set_xlabel('Movi Title')
ax2.set_ylabel('popularity')
ax2.set_xticklabels(top_10_movies_popularity['popularity'], rotation=45)
